export default function page() {
  return (
    <div className="min-h-screen p-2 bg-gradient-to-r from-rose-500 to-blue-500">
      ...
      <div className="bg-gray-900 w-[97%] h-[550px] mx-auto rounded-2xl grid md:grid-row-1 md:grid-cols-2 grid-cols-1 grid-row-2 overflow-hidden">
        <div className="flex flex-col justify-start md:justify-center items-start p-10 leading-normal gap-y-5">
          ...
          <p className="font-normal text-white text-lg md:text-xl text-center md:text-left">
            Our AI-powered platform transforms your wildlife observations into
            real-time data that helps scientist and convevationist track
            species, identify threats, and safeguard biodiversity
          </p>
        </div>
        <div className=""></div>
      </div>
